...
public class SelectGroupAdapterForAssignments extends RecyclerView.Adapter<SelectGroupAdapterForAssignments.GroupViewHolder> {
...
//    };
    ...
    public SelectGroupAdapterForAssignments(Context context, ArrayList<GroupData> groupDataArrayList) {
                ...
                ValueEventListener valueEventListener = databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(userType.equals(snapshot.child("userType").getValue().toString())){
                            Intent intent = new Intent(context, AssignmentActivityStudentEnd.class);
                            intent.putExtra("groupName", groupData.getGroupName());
                            context.startActivity(intent);
                        }else{
                            Intent intent = new Intent(context, AssignmentActivityTeacherEnd.class);
                            intent.putExtra("groupName", groupData.getGroupName());
                            context.startActivity(intent);
                        }
                    }
