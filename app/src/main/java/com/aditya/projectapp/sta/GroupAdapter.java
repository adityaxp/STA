...
//    };
    ...
    public GroupAdapter(Context context, ArrayList<GroupData> groupDataArrayList) {
    ...
    //    holder.groupImageView.setImageResource(groupData.getGroupImage());
        ...
        holder.recentMessageTextView.setText(groupData.getRecentMessage());
        holder.groupCardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, GroupChatActivity.class);
                intent.putExtra("groupName", groupDataArrayList.get(holder.getAdapterPosition()).getGroupName());
                intent.putExtra("groupImage", groupDataArrayList.get(holder.getAdapterPosition()).getGroupImage());
                intent.putExtra("groupId",groupDataArrayList.get(holder.getAdapterPosition()).getGroupKey());
